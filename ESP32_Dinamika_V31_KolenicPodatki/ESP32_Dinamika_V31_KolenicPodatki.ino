...
void SENDCurrents(){
  long millisATM = millis();
  if (client.connected()){    
    float tempaverage = average1Old - average1;
    tempaverage = abs(tempaverage);
    if(tempaverage >= 0.15 || millisATM - millisCurrent1 > 15000){
      millisCurrent1 = millisATM;
      debug += "$";
...
//      delay(20);
    ...
    tempaverage = abs(tempaverage);
    if(tempaverage >= 0.15 || millisATM - millisCurrent2 > 15000){
      millisCurrent2 = millisATM;
      debug += "$";
  ...
  //    delay(20);
    ...
    tempaverage = abs(tempaverage);
    if(tempaverage >= 0.15 || millisATM - millisCurrent3 > 15000){
      millisCurrent3 = millisATM;
      debug += "$";
  ...
  //    delay(20);
    ...
    if(tempcharge_current >= 0.15 || millisATM - millisCurrentCharge > 10000){
      millisCurrentCharge = millisATM;
      debug += "$";
  ...
  //    delay(20);
    ...
    if(temppower >= 100 || millisATM - millisPower > 10000){
      millisPower = millisATM;
      debug += "$";
      debug += "Sending Power";
      debug += "$";
    //  dynamicTopic = prefix;
