...
/*    Serial.print("naracunan tok je vecji kot ga dovolimo : ");
    Serial.println(c5);*/
    if(c5 == 5000){
      Serial.println("c5 je 5000, povecujem moc");
      debug += "#";
      debug += "c5 je 5000, povecujem moc";
      debug += "#";
      SetCurrentFlag = HIGH;
      c5 = 0;
    }
