...
//        }
    ...
    server.on("/", HTTP_POST, [](AsyncWebServerRequest * request) {
      ...
      SetWiFiCredentials();
      request->send(200, "text/html", "<h1>Done. ESP restart,<br> connect router <br>go to: <a href=\"http://" + ip + "\">" + ip + "</a><br><a href=\"http://" + mdnsdotlocalurl + ".lan\">http://" + mdnsdotlocalurl + ".lan</a> Android use BonjourBrowser App</h1>");
      delay(5000);
      ESP.restart();
    });
    server.begin();
