...
const char *ssid = "PriRudiju";
const char *password = "salovci168a";
...
void setup() {
  ...
  esp32FOTA.checkURL = "http://lockit.pro/ota/Dinamics/Salovci/Dinamics.json";
...
void CurrentFlagSet(){
  ...
  if((max_current) > (set_current + 0.5)){
    SetCurrentFlag = HIGH;
  }
}
