...
void Task1code( void * pvParameters ){
  pinMode(ct_sensor_1, INPUT_PULLDOWN);
  pinMode(ct_sensor_2, INPUT_PULLDOWN);
  pinMode(ct_sensor_3, INPUT_PULLDOWN);
  emon1.current(ct_sensor_1, 2.8); // Current: input pin, calibration 102.1 = Arduino pro mini
  emon2.current(ct_sensor_2, 2.8);
  emon3.current(ct_sensor_3, 2.8);
